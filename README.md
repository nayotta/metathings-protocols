...
- [currentActive](https://github.com/nayotta/metathings-protocols/blob/main/spec/fields/currentActive.yaml)
...
- [int](https://github.com/nayotta/metathings-protocols/blob/main/spec/formats/int.yaml)
- [map](https://github.com/nayotta/metathings-protocols/blob/main/spec/formats/map.yaml)
- [list](https://github.com/nayotta/metathings-protocols/blob/main/spec/formats/list.yaml)
- [path](https://github.com/nayotta/metathings-protocols/blob/main/spec/formats/path.yaml)
